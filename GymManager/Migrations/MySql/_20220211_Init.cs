    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    UserID = table.Column<int>("int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UserName = table.Column<string>("varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Password = table.Column<string>("varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    IsAdmin = table.Column<bool>("tinyint(1)", nullable: false),
                    IsAcive = table.Column<bool>("tinyint(1)", nullable: false),
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    LastUsedDate = table.Column<DateTime>("datetime(6)", nullable: false)
                },
                constraints: table =>
                {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    DataTrackingID = table.Column<int>("int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DataTrackingOperationID = table.Column<int>("int", nullable: false),
                    TableName = table.Column<string>("varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PrimaryKey = table.Column<string>("varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DateAdded = table.Column<DateTime>("datetime(6)", nullable: false),
                    AddedBy = table.Column<int>("int", nullable: true),
                    ModifiedBy = table.Column<int>("int", nullable: true)
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    TaxID = table.Column<int>("int", nullable: false),
                    PassTimeID = table.Column<int>("int", nullable: false),
                    AccessTimeFrom = table.Column<DateTime>("datetime(6)", nullable: true),
                    AccessTimeTo = table.Column<DateTime>("datetime(6)", nullable: true),
                    Continuation = table.Column<bool>("tinyint(1)", nullable: false),
                    DateAdded = table.Column<DateTime>("datetime(6)", nullable: false),
                    DateModified = table.Column<DateTime>("datetime(6)", nullable: true),
                    AddedBy = table.Column<int>("int", nullable: true),
                    ModifiedBy = table.Column<int>("int", nullable: true),
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    DataTrackingDefinitionID = table.Column<int>("int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DataTrackingID = table.Column<int>("int", nullable: false),
                    ColumnName = table.Column<string>("longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OldData = table.Column<string>("longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NewData = table.Column<string>("longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    EntryRegistryID = table.Column<int>("int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MemberID = table.Column<int>("int", nullable: false),
                    CabinetKeyID = table.Column<int>("int", nullable: true),
                    EntryDate = table.Column<DateTime>("datetime(6)", nullable: false),
                    ExitDate = table.Column<DateTime>("datetime(6)", nullable: true),
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    MemberID = table.Column<int>("int", nullable: false),
                    MediaCarrierID = table.Column<int>("int", nullable: false),
                    Key = table.Column<string>("varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DateAdded = table.Column<DateTime>("datetime(6)", nullable: false),
                    DateModified = table.Column<DateTime>("datetime(6)", nullable: true),
                    AddedBy = table.Column<int>("int", nullable: true),
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    MessageID = table.Column<int>("int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MemberID = table.Column<int>("int", nullable: false),
                    TextMessage = table.Column<string>("longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsEmail = table.Column<bool>("tinyint(1)", nullable: false),
                    IsSms = table.Column<bool>("tinyint(1)", nullable: false),
                    EmailSent = table.Column<bool>("tinyint(1)", nullable: false),
                    SmsSent = table.Column<bool>("tinyint(1)", nullable: false),
                    DateAdded = table.Column<DateTime>("datetime(6)", nullable: false),
                    IsAcive = table.Column<bool>("tinyint(1)", nullable: false)
                },
                constraints: table =>
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    EndDate = table.Column<DateTime>("datetime(6)", nullable: true),
                    PaymentDate = table.Column<DateTime>("datetime(6)", nullable: true),
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    PhotoID = table.Column<int>("int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MemberID = table.Column<int>("int", nullable: false),
                    Data = table.Column<byte[]>("longblob", nullable: true),
                    DateAdded = table.Column<DateTime>("datetime(6)", nullable: false),
                    DateModified = table.Column<DateTime>("datetime(6)", nullable: true),
                    AddedBy = table.Column<int>("int", nullable: true),
                    ModifiedBy = table.Column<int>("int", nullable: true)
        ...
        migrationBuilder.InsertData(
            ...
            new object[,]
            {
                { 1, new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4664), true, "A", 23 },
                { 2, new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4667), true, "B", 8 },
                { 3, new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4670), true, "C", 5 },
                { 4, new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4672), true, "D", 0 }
            });
        ...
        migrationBuilder.InsertData(
            ...
            new object[]
            {
                1, null, new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4516), null, null,
        ...
        migrationBuilder.InsertData(
            ...
            new[]
            {
                ...
                "Description", "EntryNetPrice", "EntryPrice", "IsAcive", "ModifiedBy", "Name", "NetPrice", "PassTimeID",
                "Price", "TaxID"
            },
            new object[,]
            {
                {
                    1, null, null, 1, true,
                    new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4704), null, "", 0m, 0m,
                    true, null, "BRAK", 0m, 5, 0m, 4
                },
                {
                    2, null, null, 1, true,
                    new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4710), null,
                ...
                },
                {
                    ...
                    new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4718), null,
                    "Wstpęp wolny w godz. 9-14 na miesiąc", 20.00m, 18.52m, true, null, "OPEN PORANNY", 73.15m, 3,
                    79.00m, 2
                },
                {
                    4, null, null, 1, true,
                    new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4721), null,
                    "Wstpęp wolny dla studentów", 0m, 0m, true, null, "STUDENT", 91.67m, 3, 99.00m, 2
                },
                {
                    5, null, null, 1, true,
                    new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4724), null,
                    "Wstpęp wolny na miesiąc", 0m, 0m, true, null, "PROMOCJA LUTY2022", 91.67m, 3, 99.00m, 2
                },
                {
                    6, null, null, 1, true,
                    new DateTime(2022, 2, 11, 11, 30, 9, 631, DateTimeKind.Local).AddTicks(4727), null,
