        ...
        bool access = false)
    {
        ...
        foreach (var passRegistry in passesRegistry)
                ...
                DateTime.Now.Date <= passRegistry.EndDate.Value.Date)
            {
                ...
                //Check time
                if (pass.AccessTimeFrom.HasValue && pass.AccessTimeTo.HasValue && (DateTime.Now.TimeOfDay.TotalSeconds <
        ...
        idresult = new IdentifierResult(IdentifierMessage.PassExpiration, null, member, passesRegistry.FirstOrDefault(),
